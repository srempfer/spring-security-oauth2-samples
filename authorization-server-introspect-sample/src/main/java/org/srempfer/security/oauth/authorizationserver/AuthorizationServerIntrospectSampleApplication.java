...
public class AuthorizationServerIntrospectSampleApplication {

	public static void main(String[] args) {
		SpringApplication.run(AuthorizationServerIntrospectSampleApplication.class, args);
	}
	...
	public class Controller {
		...
		@GetMapping("/")
		public String index() {
			return "Welcome to AuthorizationServer Sample with Introspect support";
		}
	...
	@Order(101)
	@Configuration
	public class OAuthEndpointWebSecurityConfig extends WebSecurityConfigurerAdapter {

		@Override
		protected void configure(HttpSecurity http) throws Exception {
			http
				.requestMatchers()
					.mvcMatchers("/oauth/introspect")
					.and()
				.authorizeRequests()
